...
| Self-host all assets (fonts, scripts); no third-party asset requests | confirmed | Triage 2026-09-08, target M1. Preserves self-hosting under D-005; NEL reports are allowed and removes an availability dependency. Font files must carry a permissive license (D-002). |
...
| No analytics or cookies; only Cloudflare NEL telemetry allowed             | confirmed        | D-005.                                                                                                                               |
